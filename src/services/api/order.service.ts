...
import { IOrderDocument, IExtendedDelivery, IDeliveredWork, IOrderMessage } from '@Emmanuel-MacAnThony/jobber-shared';
...
class OrderService {
  constructor() {
    ...
    axiosOrderInstance = axiosService.axiosInstance;
  }
